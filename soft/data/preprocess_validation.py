...
if __name__ == '__main__':
    ...
    for label in unique_labels:
        labeled_data_dir = os.path.join(output_dir, label)
    ...
    for fname in sorted(glob.iglob(data_dir + "**/*.JPEG")):
        old_filename = fname
        name = os.path.basename(old_filename)
        new_filename = os.path.join(output_dir, labels[i], name)
