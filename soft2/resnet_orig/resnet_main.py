...
from sparse_regularizers import LayerDepth
#ModelClass=resnet_model.ResNet;
class ModelClass(LayerDepth, resnet_model.ResNet): pass
...
def train(hps):
  ...
  model = ModelClass(hps, images, labels, FLAGS.mode)
  model.build_graph()
